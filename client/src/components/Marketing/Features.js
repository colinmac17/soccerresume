                ...
                <div className="row text-center">
                    <div className="col-xs-12 col-sm-4">
                        <div className="feature">
                            <i className="fa fa-universal-access fa-5x aqua" aria-hidden="true"></i>
                    ...
                    <div className="col-xs-12 col-sm-4">
                        <div className="feature">
                            <i className="fa fa-line-chart fa-5x aqua" aria-hidden="true"></i>
                    ...
                    <div className="col-xs-12 col-sm-4">
                        <div className="feature">
                            <i  className="fa fa-binoculars fa-5x aqua" aria-hidden="true"></i>
